...
interface PublicationsRepository: JpaRepository<StarPublication, Long>
interface MinimaRepository: JpaRepository<StarMinima, Long>
interface ObservationFilterRepository: JpaRepository<ObservationFilter, Long>
...
class NewOCGateInit(
        ...
        private val filterRepository: ObservationFilterRepository,
