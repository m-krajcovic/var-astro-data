...
class StarController(private val starRepository: StarRepository,
    ...
    // PREDICTIONS WILL STAY THIS WAY FOR NOW
    // EVERYTHING ELSE IS DEPRECATED AND NEW OC SHOULD BE USED
    // TODO: MOVE OC GATE FROM THIS OC CONTROLLER TO NEW OC CONTROLLER ON FRONTEND
