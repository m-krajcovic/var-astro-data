    ...
    render() {
        return (
            <Fragment>
                ...
                <Button block disabled={this.state.selectedObject == null} style={{marginTop: 8}} icon="copy" type="dashed" onClick={() => this.props.onCopy(this.parseSelectedObject())}>Copy to form</Button>
            </Fragment>
        )
    }
}
